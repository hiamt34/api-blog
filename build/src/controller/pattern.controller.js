...
var PatternController = /** @class */ (function () {
    function PatternController(service) {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.service.getDetail(query)];
                    case 1:
                        data = _a.sent();
                        if (!data) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        update = req.body;
                        return [4 /*yield*/, this.service.update(query, update)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, res.status(200).json({
                                status: true,
                    ...
                    case 2:
                        error_4 = _a.sent();
                        logger_1.default.error(error_4.message);
                        return [2 /*return*/, res.status(409).json({
                                status: false,
                                mes: error_4.message
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.service.destroy(query)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, res.status(200).json({
                                status: true,
                    ...
                    case 2:
                        error_5 = _a.sent();
                        logger_1.default.error(error_5.message);
                        return [2 /*return*/, res.status(409).json({
                                status: false,
                                mes: error_5.message
                            })];
